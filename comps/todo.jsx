...
export function TodoContent({ list = "today" }) {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto pt-10 pr-[2%]">
...
// import { isJson } from '@/hooks/apiHandlers'
// // import { addTodo } from '@/hooks/apiHandlers'
